...
try {
    ...
    $mail->Port       = 587;
    $mail->CharSet  = "utf-8";
    $mail->setFrom('ngoduykhanh2001@gmail.com', 'DHTL');
    $mail->addReplyTo('ngoduykhanh2001@gmail.com', 'DHTL');
    ...
    $mail->Body .= '<a href="http://localhost:3000/danhba/function/activation.php?accout=' . $email . '&code=' . $activationCode . '">Click here</a>';
